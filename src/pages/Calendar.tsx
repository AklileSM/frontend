  ...
  return (
    <div className="relative">
      ...
      <div className="flex justify-between items-center mb-2">
        ...
        <div className="text-sm font-semibold flex flex-wrap items-center justify-center gap-x-2 gap-y-1 text-white min-w-0 flex-1 px-1">
          <div className="relative flex items-center min-w-0">
            <select
              value={currentDate.getMonth()}
              onChange={handleMonthChange}
              aria-label="Month"
              className="appearance-none bg-transparent text-white text-sm font-semibold focus:outline-none cursor-pointer pr-6 no-scrollbar max-w-[10rem] truncate"
            >
