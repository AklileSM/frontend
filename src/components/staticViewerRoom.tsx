    ...
    <div className="w-full max-w-screen-3xl bg-white rounded-md shadow-default dark:bg-boxdark dark:text-white p-4 mx-auto mt-6">
      ...
      {viewerNotice ? (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-labelledby="static-room-viewer-notice-title"
          aria-describedby="static-room-viewer-notice-message"
          onClick={(e) => {
        ...
        >
          ...
          >
            <h2
              id="static-room-viewer-notice-title"
            ...
            <p
              id="static-room-viewer-notice-message"
