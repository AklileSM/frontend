...
async function analyzeImageOnce(imageUrl: string, fileId?: string): Promise<{ status: 202 } | { status: 200; description: string }> {
...
const AI_POLL_MAX_ATTEMPTS = 30; // up to ~60 seconds
